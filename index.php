            ...
            <div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
                        ...
                        <li><a href="#services">Portales</a></li>
                        ...
                        <div class="col-lg-6 mar-bot30">
                            <div class="responsive-slider" data-spy="responsive-slider" data-autoplay="true">
                                <div class="slides" data-group="slides">
                                    <ul>
                                        <div class="slide-body" data-group="slide">
                                            <li><img alt="" class="img-responsive" src="img/nosotros/3.jpg" width="100%" height="350"/></li>
                                            <li><img alt="" class="img-responsive" src="img/nosotros/1.jpg" width="100%" height="350"/></li>
                                            <li><img alt="" class="img-responsive" src="img/nosotros/4.jpg" width="100%" height="350"/></li>
                                        </div>
                                    </ul>
                                    <a class="slider-control left" href="#" data-jump="prev"><i class="fa fa-angle-left fa-2x"></i></a>
                                    <a class="slider-control right" href="#" data-jump="next"><i class="fa fa-angle-right fa-2x"></i></a>
                        ...
                        <div class="col-lg-6 ">
                            <div class="company mar-left10">
                                ...
                                <p>Para lograr nuestro primer objetivo contamos con un equipo capaz de realizar levantamientos de 
                                    ...
                                    con los cuales cuentan.
                                    <br/>
                                    <br/>
                                    Soporte de primera línea, centrado en la resolución de dificultades específicas y bien identificadas.
                                    Soporte avanzado cuya tarea es resolver las dificultades que requieren niveles altos de conocimientos tanto
                                    en los sistemas como en la infraestructura computacional.
                                    <br/>
                                    <br/>
                        ...
                        <div class="portfolio-items isotopeWrapper clearfix" id="3">
                                ...
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/1.jpg">Portal de inventario de equipos</a></h5>
                                            <a href="img/portafolio/1.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>

                            <article class="col-md-4 isotopeItem sistemas">
                                <div class="portfolio-item">
                                    <div class="wow bounceIn">
                                    ...
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/5.jpg">Portal de soporte</a></h5>
                                            <a href="img/portafolio/5.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>
                            ...
                            <article class="col-md-4 isotopeItem sitios">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/2.jpg">Portal Plan Funcionarios</a></h5>
                                            <a href="img/portafolio/2.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>
                            ...
                            <article class="col-md-4 isotopeItem sistemas">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/6.jpg">Sistema de respaldo en Line</a></h5>
                                            <a href="img/portafolio/6.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>
                            <article class="col-md-4 isotopeItem sitios">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/3.jpg">Encuesta calidad 2014</a></h5>
                                            <a href="img/portafolio/3.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>
                            ...
                            <article class="col-md-4 isotopeItem sistemas">
                                <div class="portfolio-item">
                                    <div class="wow bounceIn">
                                        <img src="img/portafolio/7.jpg" alt="" />
                                    </div>	
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/7.jpg">Panda Cloud</a></h5>
                                            <a href="img/portafolio/7.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>
                            <article class="col-md-4 isotopeItem sitios">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/4.jpg">EuroAwards 2014</a></h5>
                                            <a href="img/portafolio/4.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>
                            ...
                            <article class="col-md-4 isotopeItem sistemas">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-desc align-center">
                                        <div class="folio-info">
                                            <h5><a href="img/portafolio/8.jpg">Expo Vivienda 2014</a></h5>
                                            <a href="img/portafolio/8.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                        </div>										   
                                    </div>
                                </div>
                            </article>
